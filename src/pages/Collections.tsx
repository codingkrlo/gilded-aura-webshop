          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-jetblack-200 border border-silver-600 text-white rounded-lg px-3 py-2 focus:border-gold-500 focus:outline-none"
              >
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="bg-gradient-gold hover:from-gold-500 hover:to-gold-600 text-jetblack-500 font-semibold px-6 py-3 rounded-lg transition-all duration-300"
            >
              Clear Filters
            </button>
          </div>
